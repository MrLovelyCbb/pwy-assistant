...
public class QueryRepairHistoryActivity extends BaseFragmentActivity {
...
setContentView(R.layout.activity_5_2_2);
	...
	private View.OnClickListener btnQuery_OnClickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			// 跳转至查询结果界面
			Intent intent = new Intent(QueryRepairHistoryActivity.this, QueryRepairHistoryResultActivity.class);
			intent.putExtra("repair_startTime", getTxt(edit_startTime));
			intent.putExtra("repair_endTime", getTxt(edit_endTime));
			intent.putExtra("repair_uName", getTxt(edit_uName));
			intent.putExtra("repair_uPhone", getTxt(edit_uPhone));
