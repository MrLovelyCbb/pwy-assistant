...
//	private static final int COLOR_UNSELECT = Color.BLACK;
	private static final int COLOR_SELECT = Color.argb(119,4, 203, 0);
	...
	public FragmentIndicator(Context context, AttributeSet attrs) {
		...
		setBackgroundColor(Color.rgb(61, 73, 85));
		init();
	}
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.drawable.camera_icon,
				R.string.menu_btn1_str, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
		mIndicators[0].setBackgroundResource(R.color.black);
		mIndicators[0].setTag(Integer.valueOf(0));
		mIndicators[0].setOnClickListener(this);
		addView(mIndicators[0]);
		mIndicators[1] = createIndicator(R.drawable.repair_icon,
				R.string.menu_btn2_str, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
		mIndicators[1].setBackgroundColor(Color.alpha(0));
		mIndicators[1].setTag(Integer.valueOf(1));
		mIndicators[1].setOnClickListener(this);
		addView(mIndicators[1]);
		mIndicators[2] = createIndicator(R.drawable.search_icon,
				R.string.menu_btn3_str, COLOR_UNSELECT, TAG_ICON_2, TAG_TEXT_2);
		mIndicators[2].setBackgroundColor(Color.alpha(0));
		mIndicators[2].setTag(Integer.valueOf(2));
		mIndicators[2].setOnClickListener(this);
		addView(mIndicators[2]);
		
		mIndicators[3] = createIndicator(R.drawable.my_icon, R.string.menu_btn4_str, COLOR_UNSELECT, TAG_ICON_3, TAG_TEXT_3);
	...
	public static void setIndicator(int which) {
		...
		case 0:
			...
			prevIcon.setImageResource(R.drawable.camera_icon);
		...
		case 1:
			...
			prevIcon.setImageResource(R.drawable.repair_icon);
		...
		case 2:
			...
			prevIcon.setImageResource(R.drawable.search_icon);
		...
		case 3:
			...
			prevIcon.setImageResource(R.drawable.my_icon);
		...
		case 2:
			...
			currIcon.setImageResource(R.drawable.search_icon_focused);
		...
		case 3:
			...
			currIcon.setImageResource(R.drawable.my_icon_focused);
